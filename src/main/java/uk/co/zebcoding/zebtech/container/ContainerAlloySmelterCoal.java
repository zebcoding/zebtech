...
public class ContainerAlloySmelterCoal extends Container {
    ...
    private TileEntityAlloySmelterCoal alloySmelterCoal;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public ContainerAlloySmelterCoal(InventoryPlayer player,
                                     TileEntityAlloySmelterCoal tileEntityFurnace) {
        this.alloySmelterCoal = tileEntityFurnace;
    ...
    public void addCraftingToCrafters(ICrafting craft) {
        ...
        craft.sendProgressBarUpdate(this, 0, this.alloySmelterCoal.cookTime);
        craft.sendProgressBarUpdate(this, 2, this.alloySmelterCoal.burnTime);
        craft.sendProgressBarUpdate(this, 3,
                this.alloySmelterCoal.currentItemBurnTime);
    }
    ...
    public void detectAndSendChanges() {
        ...
        for (int i = 0; i < this.crafters.size(); ++i) {
            ...
            if (this.lastCookTime != this.alloySmelterCoal.cookTime) {
                craft.sendProgressBarUpdate(this, 0,
                        this.alloySmelterCoal.cookTime);
            }

            if (this.lastBurnTime != this.alloySmelterCoal.burnTime) {
                craft.sendProgressBarUpdate(this, 2,
                        this.alloySmelterCoal.burnTime);
            }

            if (this.lastItemBurnTime != this.alloySmelterCoal.currentItemBurnTime) {
                craft.sendProgressBarUpdate(this, 3,
                        this.alloySmelterCoal.currentItemBurnTime);
            }
        }

        this.lastBurnTime = this.alloySmelterCoal.burnTime;
        this.lastCookTime = this.alloySmelterCoal.cookTime;
        this.lastItemBurnTime = this.alloySmelterCoal.currentItemBurnTime;
    }

    @SideOnly(Side.CLIENT)
    public void updateProgressBar(int par1, int par2) {
        if (par1 == 0) {
            this.alloySmelterCoal.cookTime = par2;
        }

        if (par1 == 2) {
            this.alloySmelterCoal.burnTime = par2;
        }

        if (par1 == 3) {
            this.alloySmelterCoal.currentItemBurnTime = par2;
        }
    }

    @Override
    public boolean canInteractWith(EntityPlayer player) {
        return this.alloySmelterCoal.isUseableByPlayer(player);
    }
