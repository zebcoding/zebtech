...
public class GuiZechoriumCompressor extends GuiContainer {
    ...
    public GuiZechoriumCompressor(InventoryPlayer inventoryPlayer,
                               TileEntityZechoriumCompressor entity) {
        super(new ContainerZechoriumCompressor(inventoryPlayer, entity));
        this.zechoriumCompressor = entity;
    ...
    public void drawGuiContainerForegroundLayer(int var1, int var2) {
        String name = this.zechoriumCompressor.hasCustomInventoryName() ? this.zechoriumCompressor
                ...
                this.zechoriumCompressor.getInventoryName(), new Object[0]);
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2,
        ...
        i1 = this.zechoriumCompressor.getCookProgressScaled(24);
