...
public class GuiZechoriumInfuser extends GuiContainer {
    ...
    public TileEntityZechoriumInfuser zechoriumInfuser;

    public GuiZechoriumInfuser(InventoryPlayer inventoryPlayer,
                               TileEntityZechoriumInfuser entity) {
        super(new ContainerZechoriumInfuser(inventoryPlayer, entity));
        this.zechoriumInfuser = entity;
    ...
    public void drawGuiContainerForegroundLayer(int var1, int var2) {
        String name = this.zechoriumInfuser.hasCustomInventoryName() ? this.zechoriumInfuser
                .getInventoryName() : I18n.format(
                this.zechoriumInfuser.getInventoryName(), new Object[0]);
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2,
        ...
        i1 = this.zechoriumInfuser.getCookProgressScaled(24);
        this.drawTexturedModalRect(k + 79, l + 34, 176, 14, i1 + 1, 16);

        i1 = this.zechoriumInfuser.getLiquidLevelScaled(44);
