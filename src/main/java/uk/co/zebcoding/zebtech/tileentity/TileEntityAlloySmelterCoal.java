...
import uk.co.zebcoding.zebtech.blocks.BlockAlloySmelterCoal;
import uk.co.zebcoding.zebtech.crafting.AlloySmelterRecipes;

public class TileEntityAlloySmelterCoal extends TileEntity implements
        ISidedInventory {
    ...
    public void updateEntity() {
        ...
        if (flag != this.burnTime > 0) {
            flag1 = true;
            BlockAlloySmelterCoal.updateAlloySmelterCoalBlockState(
