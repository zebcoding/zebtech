...
public class TileEntityZechoriumInfuser extends TileEntityUsesZechorium implements
        ISidedInventory {
    ...
    public TileEntityZechoriumInfuser() {
        super();
    }
    ...
    public void updateEntity() {
        ...
        if (flag != this.burnTime > 0) {
            flag1 = true;
            BlockZechoriumInfuser.updateZechoriumInfuserBlockState(
    ...
    private boolean canSmelt() {
        if (this.furnaceItemStacks[0] == null) {
            ...
            ItemStack itemstack = ZechoriumInfuserRecipes
    ...
    public void smeltItem() {
        if (this.canSmelt()) {
            ItemStack itemstack = ZechoriumInfuserRecipes.getSmeltingResult(this.furnaceItemStacks[0]);
    ...
    public Packet getDescriptionPacket() {
        return PacketHandler.INSTANCE.getPacketFrom(new MessageTileEntityZechoriumInfuser(this));
    }
}
