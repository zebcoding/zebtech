...
import uk.co.zebcoding.zebtech.blocks.BlockRockPummelerBasic;
import uk.co.zebcoding.zebtech.crafting.RockPummelerRecipes;

public class TileEntityRockPummelerBasic extends TileEntity implements
        ISidedInventory {
    ...
    public void writeToNBT(NBTTagCompound tagCompound) {
        ...
        if (this.hasCustomInventoryName()) {
            tagCompound.setString("RockPummelerBasic", this.furnaceName);
        }
    }
    ...
    public void updateEntity() {
        ...
        if (flag != this.burnTime > 0) {
            flag1 = true;
            BlockRockPummelerBasic.updateRockPummelerBasicBlockState(
    ...
    private boolean canSmelt() {
        if (this.furnaceItemStacks[0] == null) {
            ...
            ItemStack itemstack = RockPummelerRecipes
