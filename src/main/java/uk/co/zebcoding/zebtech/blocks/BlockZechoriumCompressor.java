...
public class BlockZechoriumCompressor extends BlockContainer{
    ...
    public BlockZechoriumCompressor(boolean isActive) {
        super(Material.rock);
    ...
    public Item getItemDropped(int i, Random r, int j) {
        return Item.getItemFromBlock(ZBlocks.zechoriumCompressorIdle);
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z,
        ...
        if (itemstack.hasDisplayName()) {
            ((TileEntityZechoriumCompressor) world.getTileEntity(x, y, z))
    ...
    public static void updateBlockState(boolean burning, World world, int x,
        ...
        if (burning) {
            world.setBlock(x, y, z, ZBlocks.zechoriumCompressorActive);
        } else {
            world.setBlock(x, y, z, ZBlocks.zechoriumCompressorIdle);
        }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z,
        ...
        player.openGui(ZebTech.instance, ZBlocks.guiIDZechoriumCompressor, world,
                x, y, z);
        return true;
    }
    ...
    public static void updateZechoriumCompressorBlockState(boolean active,
        ...
        if (active)
            worldObj.setBlock(xCoord, yCoord, zCoord,
                    ZBlocks.zechoriumCompressorActive);
        else
            worldObj.setBlock(xCoord, yCoord, zCoord,
                    ZBlocks.zechoriumCompressorIdle);
