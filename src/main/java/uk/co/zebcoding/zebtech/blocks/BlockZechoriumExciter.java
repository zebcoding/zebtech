...
public class BlockZechoriumExciter extends BlockContainer {
    ...
    public BlockZechoriumExciter(boolean isActive) {
        super(Material.rock);
        ...
        if (this.isActive) {
            setBlockName("zechoriumExciterActive");
            setLightLevel(0.625F);
        } else {
            setBlockName("zechoriumExciterIdle");
    ...
    public Item getItemDropped(int i, Random r, int j) {
        return Item.getItemFromBlock(ZBlocks.zechoriumExciterIdle);
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z,
        ...
        if (itemstack.hasDisplayName()) {
            ((TileEntityZechoriumExciter) world.getTileEntity(x, y, z))
    ...
    public static void updateBlockState(boolean burning, World world, int x,
        ...
        if (burning) {
            world.setBlock(x, y, z, ZBlocks.zechoriumExciterActive);
        } else {
            world.setBlock(x, y, z, ZBlocks.zechoriumExciterIdle);
        }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z,
        ...
        player.openGui(ZebTech.instance, ZBlocks.guiIDZechoriumExciter, world,
                x, y, z);
        return true;
    }
    ...
    public TileEntity createNewTileEntity(World var1, int var2) {
        return new TileEntityZechoriumExciter();
    }
    ...
    public static void updateZechoriumExciterBlockState(boolean active,
        ...
        if (active)
            worldObj.setBlock(xCoord, yCoord, zCoord,
                    ZBlocks.zechoriumExciterActive);
        else
            worldObj.setBlock(xCoord, yCoord, zCoord,
                    ZBlocks.zechoriumExciterIdle);
